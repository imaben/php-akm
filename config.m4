...
if test "$PHP_AKM" != "no"; then
  ...
  PHP_NEW_EXTENSION(akm, akm.c utils.c ahocorasick/ahocorasick.c ahocorasick/mpool.c ahocorasick/node.c ahocorasick/replace.c, $ext_shared,, -DZEND_ENABLE_STATIC_TSRMLS_CACHE=1)
fi
